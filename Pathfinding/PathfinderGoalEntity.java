...
public class PathfinderGoalEntity extends PathfinderGoal {
    ...
    public PathfinderGoalEntity(EntityInsentient a, double speed, float distance) {
        this.a = a;
        this.f = speed;
        this.g = distance;
